...
export class ApplyAuditColumns1759893102351 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "Nurse" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "Nurse" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "UserToken" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "UserToken" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(`ALTER TABLE "User" ADD "deletedAt" TIMESTAMP`);
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "Patient" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "Patient" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" DROP COLUMN "updatedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "PatientInsurance" DROP COLUMN "createdAt"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" DROP COLUMN "updatedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "NurseSchedule" DROP COLUMN "createdAt"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" DROP COLUMN "updatedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "DoctorSchedule" DROP COLUMN "createdAt"`,
    );
  }
}
